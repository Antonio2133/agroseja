			...
			?>
				...
				<div class="collapse navbar-collapse justify-content-center pr-md-4" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link scroll" href="#gallery">Galeria</a>
						</li>
						<li class="nav-item">
							<a class="nav-link scroll" href="#tractores">Catalogo</a>
						</li>
...
include "Vistas/modulos/tractoresFE.php";
include "Vistas/modulos/herramientas.php";
include "Vistas/modulos/cotizador.php";
			...
			<div class="w3-head-all mb-3 w3-head-col">
				...
				<div class="col-md-4 col-sm-4 col-xs-4 footer_grid_left">
					...
					<div class="address-gried">
						<p><span>Carrt. Buenaventura-Nvo. Casas Grandes,</span></p>
					</div>
				...
				<div class="col-md-4 col-sm-4 col-xs-4 footer_grid_left">
					...
					<div class="address-gried">
						<p>
							<span><a href="mailto:info@example.com">agroseja@hotmail.com</a></span>
						</p>
					</div>
				</div>
				<div class="clearfix"> </div>
