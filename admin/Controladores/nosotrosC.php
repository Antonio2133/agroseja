...
class NosotrosC{
	...
	public function ActualizarNosotrosC(){
		...
		if(isset($_POST["tituloE"])){
			...
			$datosC = array("id"=>$_POST["Nid"], "titulo"=>$_POST["tituloE"], "introduccion"=>$_POST["introduccionE"], "descripcion"=>$_POST["descripcionE"], "descripcion2"=>$_POST["descripcionE2"], "imagen"=>$rutaImg);
