...
class GaleriaC{
	...
	public function CrearGaleriaC(){
		...
		if(isset($_POST["tituloN"])){
			...
			$datosC = array("titulo"=>$_POST["tituloN"], "subtitulo"=>$_POST["subtituloN"], 
			"descripcion"=>$_POST["descripcionN"], "orden"=>$_POST["ordenN"], "imagen"=>$rutaImg);
	...
	public function ActualizarGaleriaC(){
		...
		if(isset($_POST["Gid"])){
			...
			$datosC = array("id"=>$_POST["Gid"], "titulo"=>$_POST["tituloE"], "subtitulo"=>$_POST["subtituloE"],
            "descripcion"=>$_POST["descripcionE"], "orden"=>$_POST["ordenE"], "imagen"=>$rutaImg);
