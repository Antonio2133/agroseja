...
class SlideC{
	...
	public function CrearSlideC(){
		...
		if(isset($_POST["titularN"])){
			...
			$tableBD = "slide";
			$datosC = array("titular"=>$_POST["titularN"], "descripcion"=>$_POST["descripcionN"], 
	...
	public function ActualizarSlideC(){
		...
		if(isset($_POST["Sid"])){
			...
			$datosC = array("id"=>$_POST["Sid"], "titular"=>$_POST["titularE"], "descripcion"=>$_POST["descripcionE"], 
			"orden"=>$_POST["ordenE"], "imagen"=>$rutaImg);
	...
	public function BorrarSlideC(){
		...
		if(isset($_GET["Sid"])){
			...
			$respuesta = SlideM::BorrarSlideM($tableBD, $id);
