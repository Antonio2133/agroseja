          ...
          <table class="table table-bordered table-hover table-striped TB">
            ...
            <tbody>
              ...
              <?php
                ...
                $agroquimicos = AgroquimicoC::VerAgroquimicoC($item, $valor);

                foreach ($agroquimicos as $key => $value) {
                    ...
                    echo ' <tr>
                            ...
                            <td>
                              <div class="btn-group">
                                ...
                                <button class="btn btn-success EditarAgroquimico" AQid="'.$value["id"].'" 
                                data-toggle="modal" data-target="#EditarAgroquimico"><i class="fa fa-pencil"></i></button>
    
                                <button class="btn btn-danger BorrarAgroquimico" AQid="'.$value["id"].'" 
                                AQimagen="'.$value["imagen"].'"><i class="fa fa-times"></i></button>
      ...
      <div class="modal-content">
        ...
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          <?php
            ...
            $crearAQ = new AgroquimicoC();
            $crearAQ -> CrearAgroquimicoC();
...
<div class="modal fade" role="dialog" id="EditarAgroquimico">
      ...
      <div class="modal-content">
        ...
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          <?php
            ...
            $actualizarAQ = new AgroquimicoC();
            $actualizarAQ = ActualizarAgroquimicoC();
  ...
  <?php
    ...
    $borrarAQ = new AgroquimicoC();
    $borrarAQ -> BorrarAgroquimicoC();
