					...
					<div class="box box-primary">
						...
						<div class="box-header with-border">
							...
							<div class="box-tools pull-right">
								...
								data-toggle="tooltip"><i class="fa fa-minus"></i></button>

								<a href="index.php?url=mensajes&Mid='.$value["id"].'"><button type="button" class="btn btn-box-tool">
						...
						<div class="box-footer">
							...
							<button type="button" class="btn btn-primary btn-lg ResponderM" data-toggle="modal" 
							data-target="#ResponderM" Mid="'.$value["id"].'">Responder</button>
