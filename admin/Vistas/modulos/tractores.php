          ...
          <table class="table table-bordered table-hover table-striped TB">
            ...
            <tbody>
              ...
              <?php
                ...
                $verT = TractorC::VerTractorC($item, $valor);
...
<div class="modal fade" role="dialog" id="EditarTractor">
      ...
      <div class="modal-content">
        ...
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          <?php
            ...
            $actualizarT = new TractorC();
            $actualizarT = ActualizarTractorC();
  ...
  <?php
    ...
    $borrarT = new TractorC();
    $borrarT -> BorrarTractorC();
