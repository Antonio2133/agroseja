                ...
                echo '<tr>
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <button class="btn btn-success EditarSlide" Sid="'.$value["id"].'" data-toggle="modal" data-target="#EditarS">
                          <i class="fa fa-pencil"></i></button>

                          <button class="btn btn-danger BorrarSlide" Sid="'.$value["id"].'" imagenSlide="'.$value["imagen"].'">
