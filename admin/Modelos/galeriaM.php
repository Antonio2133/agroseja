...
class GaleriaM extends ConexionBD{
	...
	static public function CrearGaleriaM($tablaBD, $datosC){
		...
		$pdo = ConexionBD::cBD()->prepare("INSERT INTO $tablaBD (titulo, subtitulo, descripcion, orden, imagen) 
        VALUES (:titulo, :subtitulo, :descripcion, :orden, :imagen)");
	...
	static public function ActualizarGaleriaM($tablaBD, $datosC){
		...
		$pdo = ConexionBD::cBD()->prepare("UPDATE $tablaBD SET titulo = :titulo, subtitulo = :subtitulo, descripcion = :descripcion, 
