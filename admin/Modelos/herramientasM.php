...
class HerramientasM extends ConexionBD{
	...
	static public function MostrarHerramientasM($tablaBD, $item, $valor){
	...
	static public function actualizarHerramientasM($tablaBD, $datosC){

		$pdo = ConexionBD::cBD()->prepare("UPDATE $tablaBD SET icono = :icono, titulo = :titulo, descripcion = :descripcion
		WHERE id = :id");
