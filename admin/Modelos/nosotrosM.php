...
class NosotrosM extends ConexionBD{
	...
	static public function EditarNosotrosM($tablaBD, $id){
		...
		$pdo = ConexionBD::cBD()->prepare("SELECT id, titulo, introduccion, descripcion, imagen 
	...
	static public function ActualizarNosotrosM($tablaBD, $datosC){
		...
		$pdo = ConexionBD::cBD()->prepare("UPDATE $tablaBD SET titulo = :titulo, introduccion = :introduccion,
